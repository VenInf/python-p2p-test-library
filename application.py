...
node_4 = RegularNode("127.0.0.1", 8004, id=4, main_id=1, main_node_host="127.0.0.1", main_node_port=8001)
...
node_4.request_known_data(node_2.id)
time.sleep(2)

node_4.request_known_data(node_3.id)
time.sleep(2)

print(f"node_4.data_id_table -- {node_4.data_id_table}")
print(f"node_4.known_data -- {node_4.known_data}")

node_4.request_data_by_id(100)
time.sleep(2)

node_4.request_data_by_id(101)
time.sleep(2)
